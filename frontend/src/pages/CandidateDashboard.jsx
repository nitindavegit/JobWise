    ...
    return (
        <div className="pro-dashboard" style={{ minHeight: '100vh', backgroundColor: 'var(--jw-bg)', backgroundImage: 'var(--mesh-bg)' }}>
            ...
            <div className="flex flex-col md:flex-row min-h-screen pt-[64px]">
                ...
                {/* Mobile Menu Toggle */}
                <div className="jw-dash-mobile-toggle" style={{ display: 'none', justifyContent: 'space-between', alignItems: 'center', padding: '14px 20px', background: 'white', borderBottom: '1px solid #e5e7eb' }}>
